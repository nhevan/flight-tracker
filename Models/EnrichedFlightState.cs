...
/// AI-generated aircraft facts, an inferred heading derived from GPS position delta,
/// and a predicted ahead-path computed from the filed route.
...
public sealed record EnrichedFlightState(
    ...
    /// <summary>
    /// The predicted flight path ahead of the aircraft, computed from the FlightAware
    /// filed route string and local ARINC 424 navdata. Null when FlightAware is not
    /// configured or the route could not be resolved.
    /// </summary>
    PredictedFlightPath? PredictedPath = null
)
{
    /// <summary>
