    ...
    SseBroadcaster sseBroadcaster) : BackgroundService
{
        ...
        double visualRangeKm)
    {
        ...
        return new FlightSseEvent(
            ...
            OriginCity:                ef.Route?.OriginCity,
            OriginCountry:             ef.Route?.OriginCountry,
            OriginLat:                 ef.Route?.OriginLat,
            OriginLon:                 ef.Route?.OriginLon,
            DestIata:                  ef.Route?.DestIata,
            DestIcao:                  ef.Route?.DestIcao,
            DestName:                  ef.Route?.DestName,
            DestCity:                  ef.Route?.DestCity,
            DestCountry:               ef.Route?.DestCountry,
            DestLat:                   ef.Route?.DestLat,
            DestLon:                   ef.Route?.DestLon,
            RouteDistanceKm:           ef.Route?.RouteDistanceKm,
